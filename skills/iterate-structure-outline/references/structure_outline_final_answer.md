...
Once you're happy with the approach, you can use the button below to set up a worktree, or create a new session with the following command: `/rpi:setup-worktree`
